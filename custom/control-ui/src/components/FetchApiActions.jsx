...
export default function FetchApiActions() {
  ...
  const jellyfinAccent = '#707DE7'
  const jellyfinAccentRgb = '112, 125, 231'
        ...
        <div className="mb-5 flex items-center justify-between group">
          <div className="flex items-center gap-3">
            <a
              ...
              style={{ backgroundColor: 'rgba(112, 125, 231, 0.16)' }}
            >
              <span
                aria-hidden="true"
                className="block w-4 h-4"
                style={{
                  backgroundColor: '#707DE7',
          ...
          <div>
            ...
            <div className="ml-8 mt-[3px]">
              <div className="flex items-start gap-3">
                ...
                >
                  <svg className={`w-[18px] h-[18px] text-gray-500 transition-transform duration-220 ${showOptions ? 'rotate-180' : 'rotate-0'}`} fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
