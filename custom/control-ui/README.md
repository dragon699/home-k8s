...
- `VITE_JELLYFIN_URL`: Jellyfin link URL used by runtime nginx redirect `/__jellyfin__`
- `VITE_QBITTORRENT_URL`: qBittorrent link URL used by runtime nginx redirect `/__qbittorrent__`
